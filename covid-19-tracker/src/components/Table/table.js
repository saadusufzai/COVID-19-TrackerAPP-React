...
export default function Tables(provinces) {
    
    
    const pro = provinces.provinces
...
const useStyles = makeStyles({
  ...
  return (
   <div className={styles.container}>
    <Typography  color='textSecondary' variant='h4' align='center'  > COVID-19 Detail of Paksitan</Typography>
